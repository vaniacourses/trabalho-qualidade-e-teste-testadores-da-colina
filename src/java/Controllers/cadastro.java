...
public class cadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Cria o leitor apenas se existir corpo na requisição
        ...
        if (br != null) {
            ...
            // Aqui, ele Instancia um objeto do Model endereco, e Popula ele com os dados do
            // JSON
            ...
            // Aqui, ele Instancia um objeto do Model Cliente, e Popula ele com os dados do
            // JSON
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Aqui é onde a Resposta é mandada para o Cliente, dando um Feedback de que
            // tudo deu certo.
